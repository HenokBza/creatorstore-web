...
export default function CreatorsPage() {
  ...
  return (
    <div style={{ maxWidth: "1400px", margin: "40px auto", padding: "20px" }}>
      ...
      <div style={{ background: "white", borderRadius: "16px", boxShadow: "0 4px 15px rgba(0,0,0,0.05)", overflow: "visible", marginTop: "30px" }}>
        <table
          style={{
            width: "100%",
        ...
        >
          ...
          <tbody>
            {creators.map((creator, index) => {
              // Check if it's one of the last 2 rows so the menu opens upwards
              const isNearBottom = index >= creators.length - 2 && creators.length > 2;
                  ...
                  <td style={{ padding: "16px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: "12px", color: "#888" }}>{creator.storeName}</div>
                      </div>
                    </div>
                  </td>
